 ...
 */
class SubprojectsListField extends ListField
{
	/**
...
//	protected static $options = [];
     ...
     * @since __BUMP_VERSION__
     */
	protected $type = 'SubprojectsList';
...
//        }
		...
		array_unshift($options, HTMLHelper::_('select.option', '0', Text::_('COM_LANG4DEV_SELECT_SUB_PROJECT')));
