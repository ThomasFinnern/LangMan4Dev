    ...
    protected function addToolbar($Layout)
    {
        ...
        if (!empty ($this->isDevelop)) {
            echo '<span style="color:red">'
                . '<b>Tasks: </b><br>'
                . '* lang_ids by subproject ->existing <br>'
                ...
                . '* selector for all translations or one translation <br>'
                . '* Source lang ID as selection here<br>'
                . '* Target lang ID as selection with input here<br>'
                . '* <br>'
//				. '* <br>'
//				. '* <br>'
//				. '* <br>'
