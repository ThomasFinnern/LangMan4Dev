...
<form action="<?php
echo Route::_('index.php?option=com_lang4dev&view=subproject&layout=edit&id=' . (int)$this->item->id); ?>"
	...
	<div>
        ...
        <?php
        echo HTMLHelper::_('uitab.addTab', 'myTab', 'general', Text::_('COM_LANG4DEV_SUB_PROJECT')); ?>
		<div class="row">
			<div class="col-lg-9">
                <?php
                // echo'-------------- lg-9.start: ><br>'; ?>
				<div class="card">
					<div class="card-body">
						<div class="card-header" style="background-color: lightgrey;">
                            <?php
                            echo Text::_('COM_LANG4DEV_SUBPROJECT_BASE'); ?>
						</div>
						<br>
        ...
        <?php
        echo HTMLHelper::_('uitab.addTab', 'myTab', 'publishing', Text::_('INFO')); ?>
		<div class="row">
