...
?>
<form action="<?php echo Route::_('index.php?option=com_lang4dev&view=maintenance'); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
    ...
    ?>
			...
			<div class="main-vertical-stack" style="display: flex; flex-direction: column; justify-content: space-between">
				<div class="vertical-header" >
					<h2><?php echo Text::_('COM_LANG4DEV_MAINTENANCE') ;?></h2>
					<strong><?php echo Text::_('COM_LANG4DEV_MAINTENANCE_DESC') ;?></strong>
				</div> 
